<%@ Page Title="" Language="C#" MasterPageFile="~/Yönetim/Admin.Master" AutoEventWireup="true" CodeBehind="PaketDüzenleSil.aspx.cs" Inherits="SeyahatWeb.Yönetim.PaketDüzenleSil" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form runat="server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbTravelConnectionString %>" DeleteCommand="DELETE FROM [tblTurPaket] WHERE [id] = @id" InsertCommand="INSERT INTO [tblTurPaket] ([Adi], [Fiyat], [Sure], [Lokasyon], [Resim], [Detay]) VALUES (@Adi, @Fiyat, @Sure, @Lokasyon, @Resim, @Detay)" SelectCommand="SELECT * FROM [tblTurPaket]" UpdateCommand="UPDATE [tblTurPaket] SET [Adi] = @Adi, [Fiyat] = @Fiyat, [Sure] = @Sure, [Lokasyon] = @Lokasyon, [Resim] = @Resim, [Detay] = @Detay WHERE [id] = @id">
        <DeleteParameters>
